...
const complexMaze2 = [
    [OPEN, OPEN, OPEN, OPEN, OPEN, LAVA, GOAL, LAVA],
    [LAVA, LAVA, LAVA, LAVA, OPEN, LAVA, OPEN, LAVA],
    [LAVA, OPEN, OPEN, OPEN, LAVA, LAVA, OPEN, OPEN],
    [LAVA, LAVA, LAVA, OPEN, OPEN, OPEN, LAVA, OPEN],
    [LAVA, LAVA, LAVA, OPEN, LAVA, LAVA, OPEN, OPEN],
    [OPEN, OPEN, OPEN, OPEN, LAVA, LAVA, OPEN, LAVA],
    [OPEN, LAVA, LAVA, OPEN, OPEN, OPEN, OPEN, LAVA],
    [OPEN, LAVA, LAVA, LAVA, OPEN, OPEN, LAVA, LAVA]
];

const complexMaze3 = [
    [OPEN, LAVA, LAVA, LAVA, LAVA, LAVA, OPEN, OPEN],
    [OPEN, LAVA, LAVA, OPEN, OPEN, OPEN, OPEN, LAVA],
    [OPEN, OPEN, LAVA, OPEN, LAVA, LAVA, OPEN, GOAL],
    [OPEN, LAVA, LAVA, OPEN, LAVA, LAVA, LAVA, LAVA],
    [OPEN, LAVA, LAVA, OPEN, OPEN, OPEN, LAVA, OPEN],
    [OPEN, OPEN, OPEN, LAVA, LAVA, OPEN, LAVA, OPEN],
    [OPEN, LAVA, OPEN, OPEN, OPEN, OPEN, LAVA, OPEN],
    [OPEN, LAVA, OPEN, LAVA, LAVA, OPEN, OPEN, OPEN]
];
